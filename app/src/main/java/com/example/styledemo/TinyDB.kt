...
//    fun getListObject(key: String, mClass: Class<Cart>): ArrayList<Cart> {
//        val gson = Gson()
//
//        val objStrings = getListString(key)
//        val objects: ArrayList<Cart> = ArrayList()
//
//        for (mObjString in objStrings) {
//            val value = gson.fromJson<Cart>(mObjString, mClass)
//            objects.add(value)
//        }
//        return objects
//    }
//
//    fun getListProductHistory(
//        key: String,
//        mClass: Class<ProductSearchHistory>
//    ): ArrayList<ProductSearchHistory> {
//        val gson = Gson()
//
//        val objStrings = getListString(key)
//        val objects: ArrayList<ProductSearchHistory> = ArrayList()
//
//        for (mObjString in objStrings) {
//            val value = gson.fromJson<ProductSearchHistory>(mObjString, mClass)
//            objects.add(value)
//        }
//
//        return objects
//    }
    ...
    //        Object value = x_new Gson().fromJson(json, classOfT);
    //        if (value == null)
    //            throw x_new NullPointerException();
    //        return value;
    //    }
...
//    fun putListProductHistory(key: String, objArray: ArrayList<ProductSearchHistory>) {
//        checkForNullKey(key)
//        val gson = Gson()
//        val objStrings: ArrayList<String> = ArrayList()
//        for (obj in objArray) {
...
//        	checkForNullKey(key);
//        	Gson gson = x_new Gson();
//        	ArrayList<String> objStrings = x_new ArrayList<String>();
...
//    fun putListObject(key: String, objArray: ArrayList<Cart>) {
//        checkForNullKey(key)
//        val gson = Gson()
//        val objStrings: ArrayList<String> = ArrayList()
//        for (obj in objArray) {
